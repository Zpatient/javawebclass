    ...
    <script type="text/javascript">
      ...
      //  setInterval(function (){isSelect();},2000);
        function getDetail(questionId){
            var url = "http://localhost:8080/question/getdetail?id="+questionId;
            $(location).attr('href',url);
        }
    </script>
</head>
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <span class="h4 center-block col-md-2" style="padding-top: 5px">消息列表</span>
                                </div>
                                <div class="table-responsive m-t-20 no-wrap" style="margin-top:0;">
                                    <table class="table vm no-th-brd pro-of-month table-hover table-bordered">
                                        ...
                                        <c:forEach var="message" items="${messages}">
                                            <tr>
                                                <td class = "col-md-5" style="text-align: center"><h6>${message.question}</h6></td>
