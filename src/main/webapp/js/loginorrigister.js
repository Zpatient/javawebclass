//密码框失去焦点后验证value值
function oBlur_2() {
    var a = document.getElementsByClassName("password")[0].value;
    var b = document.getElementsByClassName("password")[1].value;
    if (a!==b) { //两次密码不相同
        document.getElementById("remind_1").innerHTML = "两次密码不一致！";
    } else { //两次密码相同
...
// function oBlur_1() {
//     if (!a) { //用户框value值为空
//         document.getElementById("remind_1").innerHTML = "请输入账号！";
