...
<head>
    ...
    <script type="text/javascript">
        ...
        setInterval(function (){isSelect();},2000);
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="${pageContext.request.contextPath}/student/getquestion" aria-expanded="false">
                            <i class="fa active fa-tachometer"></i><span class="h5 hide-menu font-weight-bold">我的提问<span style="color: red;font-weight: normal;font-size: 14px;">(${count}条未读)</span></span></a>
                        </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-20 no-wrap" style="margin-top:0;">
                                    <table class="table vm no-th-brd pro-of-month table-hover table-bordered">
                                        <thead>
                                        <tr>
                                            <td class = "h7 col-md-5 font-weight-bold" style="text-align: center">课程名称</td>
                                            <td class = "h7 col-md-2 font-weight-bold" style="text-align: center">授课教师</td>
                                            <td class = "h7 col-md-2 font-weight-bold" style="text-align: center">课程简介</td>
                                            <td class = "h7 col-md-2 font-weight-bold" style="text-align: center">课程评分</td>
                                            <td class = "h7 col-md-1 font-weight-bold" style="text-align: center">进入课程</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="courseView" items="${courseViews}">
                                            <tr>
                                                <td class = "col-md-2" style="text-align: center"><h6>${courseView.name}</h6></td>
                                                <td class = "col-md-2" style="text-align: center">${courseView.teacher}</td>
